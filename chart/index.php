...
<?php
    ...
    $result = mysqli_query($conn, "SELECT Monthname(bulan) as bulan,jumlahPendaftar,jumlahDiterima FROM penerimaan GROUP BY MONTH(bulan) DESC");
...
<head lang="kr">
    ...
    <title>Grafik Pertama Melysa</title>
